import { ActionType } from 'patterns/context-reducer-I/reducer';
import { RGBContext } from 'patterns/context-reducer-I/rgb-context';
import { useContext } from 'react';

const ColorPalette = (): JSX.Element => {
  // STEP 5-2：取出 RGBContext 的方法
  const { red, green, blue, dispatch } = useContext(RGBContext);

  // STEP 5-3：使用 dispatch
